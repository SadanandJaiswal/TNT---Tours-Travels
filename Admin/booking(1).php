        ...
        <div class="body">
            <div class="sidemenu">
                ...
                <nav class="nav">
                    ...
                    <a href="Booking.php"><li class="li active"><span><i class="fa-solid fa-ticket"></i></span> Booking</li></a>
            ...
            <div class="rightframe">
                <?php
                    ...
                    echo " <center><h3>Booking</h3></center>";
                    $sql="SELECT * FROM booking";

                    $res=mysqli_query($conn2,$sql);

                    echo '<center><table border=2 cellspacing=0>
                    <tr><td>User ID</td><td>Booking ID</td><td>Name</td><td>Email</td><td>Phone</td><td>Address</td><td>From</td><td>To</td><td>Boarding_date</td><td>Arrival Date</td></tr>';
