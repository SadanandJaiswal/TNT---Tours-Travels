...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>TNT | Registered User</title>
    </head>
    <body>
        <div class="body">
        <div class="sidemenu">
                ...
                <nav class="nav">
                    ...
                    <a href="RegisteredUser.php"><li class="li active"><span><i class="fa fa-users"></i> </span>Registered Usesr</li></a>
            ...
            <div class="rightframe">
                <?php
                    ...
                    echo " <center><h3>Registered User</h3></center>";
