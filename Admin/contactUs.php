...
<!DOCTYPE html>
    ...
    <head>
        ...
        <title>TNT | ContactUs_Admin</title>
    </head>
    <body>
        <div class="body">
        <div class="sidemenu">
                ...
                <nav class="nav">
                    ...
                    <a href="contactUs.php"><li class="li active"><span><i class="fa-solid fa-train"></i></span> contact Us</li></a>
            ...
            <div class="rightframe">
                <?php
                    ...
                    echo " <center><h3>Contact Us</h3></center>";
                    $sql="SELECT * FROM `contact_us`";

                    $res=mysqli_query($conn2,$sql);

                    echo '<center><table border=2 cellspacing=0>
                    <tr><th>User ID </th><th>F Name</th><th>L Name</th>Email</th><th>Phone</th><th>Message</th></tr>';
