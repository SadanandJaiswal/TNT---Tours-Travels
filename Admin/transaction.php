        ...
        <div class="body">
           <div class="sidemenu">
                ...
                <nav class="nav">
                    ...
                    <a href="transaction.php"><li class="li active"><span><i class="fa-solid fa-money-bill-wave"></i></span> Transaction</li></a>
                </nav>
            ...
            <div class="rightframe">
                <?php
                    ...
                    echo " <center><h3>Transactions</h3></center>";
